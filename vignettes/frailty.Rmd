...
agreement (we use `tidy_re` from the `pamm` package to extract random effects):
...
The `pamm` package also provides a convenience function for a quantile-quantile plot of the estimated frailties to check the Gaussian assumption:
