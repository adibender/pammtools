...
```{r fig.width = 6, fig.height = 4, echo = FALSE, out.height = "300px", fig.cap = "SOFA profiles for individual patients. Each line represents a patient, each dot represents a measurement."}
