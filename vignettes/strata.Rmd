...
For illustration we again use the `veteran` data from the `survival` package, 
...
gg.bz +	aes(col="Nelson-Aalen") +
	geom_step(data=pinf, aes(x=tend, y=cumhazard, group=strata, col="PAM")) +
  geom_stepribbon(data=pinf, aes(x=tend, ymin=cumlower, ymax = cumupper,
