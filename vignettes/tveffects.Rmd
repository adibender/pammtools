...
Holding the Karnofsky Score constant, we can see how its effect
changes over time for different values of $x_{\text{karno}}$ (middle panel). 
For higher values $x_{\text{karno}} >60$ the effect is negative (decreased log-hazard)
...
that for lower $x_{\text{karno}}$ values the effect may have a parabolic shape, 
