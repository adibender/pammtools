...
This might seem a little convoluted, but can be easily generalized to situations
with complex covariate specifications for the two data sets being compared as
well as in case of time-varying effects, time-dependent covariates, etc.
