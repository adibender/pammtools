...
Data transformation as usual is performed using the `as_ped` function
as described in the [data-transformation vignette](data-transformation.html)
...
## combine figures
gridExtra::grid.arrange(bili_gg, protime_gg, nrow = 1L)
```
</details>
