...
#' @name dplyr_verbs
#' @title \code{dplyr} Verbs for \code{nested_fdf}-Objects
#' @param .data an  object of class \code{nested_fdf}, see \code{\link{as_nested_fdf}}.
#' @param tbl an  object of class \code{nested_fdf}, see \code{\link{as_nested_fdf}}.
#' @param x an  object of class \code{nested_fdf}, see \code{\link{as_nested_fdf}}.
...
#' @return a modified \code{nested_fdf} object (except for \code{do})
#' @import dplyr
...
#' @name tidyr_verbs
#' @title \code{tidyr} Verbs for \code{nested_fdf}-Objects
#' @param data an  object of class \code{nested_fdf}, see \code{\link{as_nested_fdf}}.
#' @return A modified \code{nested_fdf} object.
...
# #' @export
# #' @rdname tidyr_verbs
# fill_.nested_fdf <- function(data, fill_cols, .direction=c("down", "up")) {

#   data_attr   <- nested_fdf_attr(data)
#   tbl <- re_nested_df(fill_(un_nested_df(data), fill_cols, .direction))
#   attributes(tbl) <- c(attributes(tbl), data_attr)
